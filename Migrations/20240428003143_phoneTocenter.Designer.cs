...
namespace QuickFix.Migrations
{
    ...
    [Migration("20240428003143_phoneTocenter")]
    partial class phoneTocenter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickFix.OrdersService.Models.Orders", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<DateTime?>("PeriodByDay")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasColumnName("period_by_day")
                        .HasDefaultValueSql("getdate()");
            ...
            modelBuilder.Entity("QuickFix.Settings.Screens.Model.ScreenModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("IconImge")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("icon_imge");
                    ...
                    b.HasIndex("HashName")
                        .IsUnique()
                        .HasFilter("[hash_name] IS NOT NULL");

                    b.ToTable("screens", (string)null);
                });

            modelBuilder.Entity("QuickFix.Settings.Screens.Model.UserScreen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_screen_role");

                    b.HasIndex("ScreenId");

                    b.HasIndex("UserId");

                    b.ToTable("screen_role", (string)null);
                });
            ...
            modelBuilder.Entity("QuickFix.OrdersService.Models.Orders", b =>
                {
                    b.HasOne("QuickFix.Addresses.Models.AddressModel", "Address")
                        .WithOne("Orders")
                        .HasForeignKey("QuickFix.OrdersService.Models.Orders", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("QuickFix.Settings.Screens.Model.UserScreen", b =>
                {
                    b.HasOne("QuickFix.Settings.Screens.Model.ScreenModel", "Screen")
                        .WithMany("Role")
                        .HasForeignKey("ScreenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_screen_role_screens_screen_id");
                    ...
                    b.HasOne("QuickFix.Identity.Shared.Models.ApplicationUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_screen_role_asp_net_users_user_id");
