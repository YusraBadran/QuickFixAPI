...
public class JwtService : IJwtService
{
    ...
    public async Task<GenerateTokenResult> GenerateJwtToken(
        string userName,
        string email,
        string userId,
    ...
    )
    {
        ...
        var jwtClaims = new List<Claim>
        {
            ...
            new ("expireTime", _jwtOptions.TokenLifeTimeSecond.ToString()),
            new(
        ...
        Guard.Against.Null(_jwtOptions.SecretKey, nameof(_jwtOptions.SecretKey));
        ...
        var expireTime = now.AddMinutes(_jwtOptions.TokenLifeTimeSecond == 0 ? 1800 : _jwtOptions.TokenLifeTimeSecond);
