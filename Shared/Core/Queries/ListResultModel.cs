    ...
    where T : notnull
{
    ...
    public static ListResultModel<T> Create(List<T> Data, long totalItems = 0, int page = 1, int pageSize = 5, int totalPages = 0, int currentStartIndex = 1, int currentEndIndex = 5)
    {
