...
public class GenerateJwtTokenHandler : IRequestHandler<GenerateJwtToken, GenerateTokenResult>
{
    ...
    public async Task<GenerateTokenResult> Handle(GenerateJwtToken request, CancellationToken cancellationToken)
    {
        ...
        var tokenResult = await _jwtService.GenerateJwtToken(
        ...
        return new GenerateTokenResult(tokenResult.AccessToken, tokenResult.ExpireAt);
    }
